...
files=['negative.txt','positive.txt','poeanalysis.txt']
...
a=0
b=0
for x in positive_counts:
  a+=x
for y in negative_counts:
  b+=y
print "\n\n"
print "Positivity is ",a,"\n\n"
print "Negativity is ",b,"\n\n"
